...
.DATA
    ...
    header          DB '            Cebu Institute of Technology - University', 13,10
                    DB '                 Minbenbo Switch Accessory EShop',13,10
                    DB '            Programmer: LANCE JOSEPH LORENZ S. ENARIO',13,10
                    DB '                        Copyright 2024',13,10,10, '$'

    branding        DB '     _________________________________________________________   ',13, 10                                                                                           
                    DB '    /       - |  _________________________________  |  +      \   ',13, 10                                        
                    DB '   /   ___    |  |            ^-^                |  |     O    \   ',13, 10                                      
                    DB '  {   /   \   |  |    :3             ovo         |  |   O   O   }  ',13, 10                                       
                    DB '  {   \___/   |  |                               |  |     O     }   ',13, 10                                     
                    DB '  {           |  |  ^^    MINBENBO SWITCH   o~o  |  |           }    ',13, 10    
                    DB '  {     O     |  |        ACCESSORY ESHOP        |  |    ___    }   ',13, 10    
                    DB '  {   O   O   |  |  :3                           |  |   /   \   }    ',13, 10    
                    DB '  {     O     |  |          _____        ^-^     |  |   \___/   }   ',13, 10     
                    DB '  {        () |  |         <_o.o_>               |  | O         }     ',13, 10                                                                                                                          
                    DB '   \          |  |_______________________________|  |          /  ',13, 10    
                    DB '    \_________|_____________________________________|_________/    ',13, 10                                                                                                                                              
                    DB '   $',13, 10    

    setup           DB 13,10,'  ',13,10
                    DB '  Hello customer! Welcome to the Minbenbo Switch Accessory Store ^-^',13,10
                    DB '  Please create an account!$',13,10,13,10
    ...
    landing_header   DB ' Welcome to Minbenbo Switch Accessory EShop!                                  $',13,10
    ...
    order_accessories  DB '----SELECT ACCESSORIES----', 13,10
                    DB ' Case         -  P200.00', 13,10
                    DB ' Glass        -  P100.00', 13,10
                    DB ' Grip Case    -  P250.00', 13,10
                    DB ' Capture Card -  P400.00', 13,10
                    DB ' Powerbank    -  P350.00$', 13,10, 13,10

    case_price          dw 200
    glass_price         dw 100
    grip_case_price     dw 250 
    capture_price       dw 400
    powerbank_price     dw 350

    item_amount  DB 13,10,13,10,'  Input number of an item: $'

    curr_order           DB '----YOUR CURRENT ORDER----$'
    curr_case            DB 13,10,' Case         - $'
    curr_glass           DB 13,10,' Glass        - $'
    curr_grip_case       DB 13,10,' Grip Case    - $'
    curr_capture         DB 13,10,' Capture Card - $'
    curr_powerbank       DB 13,10,' Powerbank    - $'

    order_case           DB 13,10,'  Case       : $'
    order_glass          DB '  Glass      : $'
    order_grip_case      DB '  Grip Case  : $'
    order_capture        DB '  Capture Cd : $'
    order_powerbank      DB '  Powerbank  : $'
    ...
    exit_msg    DB 'Thank you for ordering! We hope you enjoy your accessories!$'
